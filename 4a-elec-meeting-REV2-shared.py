...
user_first_spread_name = str(input("Enter name of 4A spreadsheet file (including file type): "))
...
columns_to_copy = ['Permit Facilitator', 'Permit Facilitator LAN ID', 'Latest Expiration Date', 'E Permit Status', 'EPWC Comments']
sheet_names = ['ED_SAN JOSE GC', 'ED_CUPERTINODIV', 'ED_CINNABARDIV', 'ED_EDENVALEDIV', 'GD_SAN JOSE GCGC']

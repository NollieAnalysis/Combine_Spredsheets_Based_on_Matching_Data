...
user_first_spread_name = str(input("Enter name of DA picklist spreadsheet file (including file type): "))
...
sheet_names = ['CUPERTINO', 'GC']  # The name or index of the sheets you want to use in the first spreadsheet
